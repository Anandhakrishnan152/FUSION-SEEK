        ...
        <div className="flex-1 overflow-y-auto p-12 animate-slide-up">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="flex items-center gap-6 mb-12">
                    <div className={`p-6 rounded-[2rem] shadow-2xl ${theme === 'dark' ? 'bg-indigo-600 text-white' : 'bg-white text-indigo-600'}`}>
                        <User size={40} />
                    </div>
                    <div>
                        <h2 className={`text-5xl font-black italic uppercase tracking-tighter ${theme === 'dark' ? 'text-white' : 'text-slate-900'}`}>Identity Node</h2>
                        <p className="text-slate-500 text-[11px] font-black uppercase tracking-[0.4em]">Operative Profile & Stats</p>
                    </div>
                </div>

                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    {/* ID Card */}
                    <div className={`lg:col-span-1 p-8 rounded-[3rem] relative overflow-hidden group ${theme === 'dark' ? 'glass border-white/10' : 'bg-white border border-slate-200 shadow-xl'
                        }`}>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className={`p-6 rounded-[2.5rem] ${theme === 'dark' ? 'bg-white/5 border border-white/5' : 'bg-white border border-slate-100 shadow-lg'}`}>
                        ...
                        {/* Neural bio */}
                        <div className={`p-8 rounded-[2.5rem] ${theme === 'dark' ? 'glass border-white/5' : 'bg-white border border-slate-200 shadow-xl'}`}>
